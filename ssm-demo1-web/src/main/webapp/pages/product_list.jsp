    ...
    <div class="layui-body" style="float: left">
        ...
        <form action="">
            <table class="layui-table" lay-even lay-skin="row,line">
                ...
                <tbody>
                <c:forEach items="${productPageInfo.list}" var="product" varStatus="s">
                    <tr>
        ...
        <div style="float: right">
            总页数：${productPageInfo.pages},总记录数：${productPageInfo.total},每页显示：${productPageInfo.pageSize},当前页：${productPageInfo.pageNum}
            <a href="${pageContext.request.contextPath}/product/findAll.do?pageNum=1"
               class="layui-btn layui-btn-sm">首页</a>
            <a href="${pageContext.request.contextPath}/product/findAll.do?pageNum=${productPageInfo.pageNum-1}&pageSize=${productPageInfo.pageSize}"
               class="layui-btn layui-btn-sm">上一页</a>
            <c:forEach begin="1" end="${productPageInfo.pages}" var="currentPage">
                <a href="${pageContext.request.contextPath}/product/findAll.do?pageNum=${currentPage}&pageSize=${productPageInfo.pageSize}"
                   class="layui-btn layui-btn-sm">${currentPage}</a>
            </c:forEach>
            <a href="${pageContext.request.contextPath}/product/findAll.do?pageNum=${productPageInfo.pageNum+1}&pageSize=${productPageInfo.pageSize}"
               class="layui-btn layui-btn-sm">下一页</a>
            <a href="${pageContext.request.contextPath}/product/findAll.do?pageNum=${productPageInfo.pages}"
